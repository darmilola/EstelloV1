...
public class RecommendedCourseAdapter extends RecyclerView.Adapter<RecommendedCourseAdapter.itemViewHolder> {

    ArrayList<CoursesModel> courses_modelArrayList;
    Context context;


    public RecommendedCourseAdapter(ArrayList<CoursesModel> courses_models, Context context) {
