...
public class TrainingAnnouncementAdapter extends RecyclerView.Adapter<TrainingAnnouncementAdapter.viewHolder> {

    Context context;
    ArrayList<TrainingPostModel> trainingPostModelArrayList;

    public TrainingAnnouncementAdapter(Context context, ArrayList<TrainingPostModel> trainingPostModelArrayList){
