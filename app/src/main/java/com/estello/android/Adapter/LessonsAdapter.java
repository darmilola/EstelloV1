...
public class LessonsAdapter extends RecyclerView.Adapter<LessonsAdapter.itemViewHolder> {
    ...
    public LessonsAdapter(ArrayList<CoursesModel> courses_models, Context context){
    ...
    public itemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.course_activity_lessons_recycler_item, parent, false);
