...
public class LearningClassesAdapter extends RecyclerView.Adapter<LearningClassesAdapter.itemViewHolder> {

    ArrayList<CoursesModel> courses_modelArrayList;
    Context context;


    public LearningClassesAdapter(ArrayList<CoursesModel> courses_models, Context context){
