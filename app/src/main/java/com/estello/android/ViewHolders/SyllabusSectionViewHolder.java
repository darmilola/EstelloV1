...
public class SyllabusSectionViewHolder extends ParentViewHolder {
    /**
     * Default constructor.
     *
    ...
    public SyllabusSectionViewHolder(@NonNull final View itemView) {
        super(itemView);
        sectionDivisional = itemView.findViewById(R.id.syllabus_section_divisional);
        sectionTitle = itemView.findViewById(R.id.syllabus_section_title);
        Typeface customfont= Typeface.createFromAsset(itemView.getContext().getAssets(),"montsemi.ttf");
        dropdown = itemView.findViewById(R.id.section_drop_down_icon);
