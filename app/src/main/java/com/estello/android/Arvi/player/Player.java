...
import com.estello.android.Arvi.player.util.VolumeController;
...
public interface Player {
    ...
    /**
     * Registers the {@link EventListener} to be used for the handling of the {@link Player}-related events.
     *
