 ...
 */
public class ExploreChannelPrivateChannel extends Fragment {


    View view;
    RecyclerView recyclerView;
    ArrayList<ChannelsModel> channelsModelArrayList = new ArrayList<>();
    public ExploreChannelPrivateChannel() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_explore_channel_private_channel, container, false);
    ...
    private void initView(){
        ...
        recyclerView = view.findViewById(R.id.private_channel_recyclerview);
        for(int i = 0; i < 10; i++){
