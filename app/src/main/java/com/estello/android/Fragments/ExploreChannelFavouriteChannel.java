 ...
 */
public class ExploreChannelFavouriteChannel extends Fragment {


    View view;
    RecyclerView recyclerView;
    ArrayList<ChannelsModel> channelsModelArrayList = new ArrayList<>();
    public ExploreChannelFavouriteChannel() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view = inflater.inflate(R.layout.fragment_explore_channel_favourite_channel, container, false);
    ...
    private void initView(){
        ...
        recyclerView = view.findViewById(R.id.favourite_channel_recyclerview);
        for(int i = 0; i < 10; i++){
