...
package com.deltastream.example.edittextcontroller.converter.tagsoup;
...
public class HTMLWriter extends XMLFilterImpl implements LexicalHandler {
     ...
     * declared; to do that, use the {@link #forceNSDecl(String)
     ...
     *
     * @throws SAXException If there is an error writing the XML declaration, or if a
     ...
     * Pass the event on down the filter chain for further processing.
     *
     * @throws SAXException If there is an error writing the newline, or if a handler
     ...
     * @throws SAXException If there is an error writing the start tag, or if a
     *                                  handler further down the filter chain raises an exception.
     ...
     *                  template for generating a prefix if necessary, but it is not
     *                  guaranteed to use the same qName.
     * @throws SAXException If there is an error writing the end tag, or if a handler
     *                                  further down the filter chain raises an exception.
     ...
     * @throws SAXException If there is an error writing the characters, or if a
     *                                  handler further down the filter chain raises an exception.
     ...
     * @param start  The starting position in the array.
     * @param length The number of characters to write.
     * @throws SAXException If there is an error writing the whitespace, or if a
     *                                  handler further down the filter chain raises an exception.
     ...
     * @throws SAXException If there is an error writing the PI, or if a handler
     *                                  further down the filter chain raises an exception.
     ...
     * @throws SAXException If there is an error writing the character, this method
     ...
     *
     * @param s
     * @throws SAXException If there is an error writing the string, this method will
