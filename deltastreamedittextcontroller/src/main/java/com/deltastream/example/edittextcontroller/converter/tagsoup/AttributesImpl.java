 ...
 * {@link Attributes Attributes} interface, with the addition of
...
public class AttributesImpl implements Attributes {
     ...
     * @param type      The attribute type as a string.
     * @param value     The attribute value.
     * @throws ArrayIndexOutOfBoundsException When the supplied index does not point to an attribute in
     *                                                  the list.
     */
